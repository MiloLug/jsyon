 ...
 * */
function addAB(a, b){
return new Walker(new Parser(`
    this a + [follow_ctx: this b]
`).parse(), {a, b}).run();
}

function createBlock(addToSelector, tag, className, style){
return hornyRun(`
    document querySelector [@: this addToSelector] appendChild [@:
        std Obj [
            @: Array [element, @: document createElement [@: this tag]],
            @: Array [classNem, @: this className],
...
`, {addToSelector, tag, style, className});
}
